...
export default function EventsPage() {
  ...
  const loadEvents = async (searchFilters?: SearchFilters) => {
    ...
    try {
      ...
      if (currentFilters.event_type && currentFilters.event_type !== "All Types") {
        query = query.eq("event_type", currentFilters.event_type)
      }
      if (currentFilters.skill_level && currentFilters.skill_level !== "All Levels") {
  ...
  const hasActiveFilters = Object.values(filters).some((value) => value !== "" && !value.startsWith("All"))
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-muted-foreground mt-2">Join action sports events and meetups in your area</p>
          </div>
          {user?.role === "business" && (
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Select
              ...
              onValueChange={(value) => setFilters({ ...filters, skill_level: value })}
            >
              <SelectTrigger className="w-[150px]">
                <SelectValue />
              </SelectTrigger>
          ...
          {hasActiveFilters && (
            <div className="flex flex-wrap gap-2">
              ...
              {filters.event_type && filters.event_type !== "All Types" && (
                <Badge variant="secondary">Type: {filters.event_type.replace("_", " ")}</Badge>
              )}
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-muted-foreground">No events found. Try adjusting your search filters.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {events.map((event) => (
