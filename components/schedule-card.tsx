...
export function ScheduleCard({ schedule, showUser = false, onDelete, canDelete = false }: ScheduleCardProps) {
    ...
    <Card className="h-full">
      <CardHeader className="pb-3">
        <div className="flex justify-between items-start">
          ...
          {canDelete && onDelete && (
            <Button variant="ghost" size="sm" onClick={() => onDelete(schedule.id)} className="text-destructive">
